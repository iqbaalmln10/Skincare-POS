...
const _commonjsDynamicModules = require("./_commonjs-dynamic-modules-cKR5g6Pv.js");
...
const EventEmitter = /* @__PURE__ */ _commonjsDynamicModules.getDefaultExportFromCjs(eventemitter3Exports);
...
(function(exports2) {
  var __createBinding = _commonjsDynamicModules.commonjsGlobal && _commonjsDynamicModules.commonjsGlobal.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === void 0) k2 = k;
  ...
  __exportStar(decoder, exports2);
  __exportStar(encoder, exports2);
})(dist$5);
var dist$4 = {};
var utils = {};
(function(exports2) {
...
var __importDefault$3 = _commonjsDynamicModules.commonjsGlobal && _commonjsDynamicModules.commonjsGlobal.__importDefault || function(mod) {
...
function requireNodeGypBuild() {
  ...
  var path$1 = path;
  var os = require$$0$1;
  var runtimeRequire2 = typeof __webpack_require__ === "function" ? __non_webpack_require__ : _commonjsDynamicModules.commonjsRequire;
...
const runtimeRequire = typeof __webpack_require__ === "function" ? __non_webpack_require__ : _commonjsDynamicModules.commonjsRequire;
...
var __importDefault$2 = _commonjsDynamicModules.commonjsGlobal && _commonjsDynamicModules.commonjsGlobal.__importDefault || function(mod) {
  return mod && mod.__esModule ? mod : { "default": mod };
};
...
loadBindings.asyncWrite = binding.read ? (0, util_1.promisify)(binding.write) : async () => {
...
(function(exports2) {
  var __importDefault2 = _commonjsDynamicModules.commonjsGlobal && _commonjsDynamicModules.commonjsGlobal.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { "default": mod };
  };
  Object.defineProperty(exports2, "__esModule", { value: true });
...
(function(exports2) {
  ...
  const unixRead2 = async ({ binding: binding2, buffer, offset, length, fsReadAsync = readAsync }) => {
    ...
    try {
      ...
      if (bytesRead === 0) {
        return (0, exports2.unixRead)({ binding: binding2, buffer, offset, length, fsReadAsync });
      }
...
(function(exports2) {
  ...
  const unixWrite2 = async ({ binding: binding2, buffer, offset = 0, fsWriteAsync = writeAsync }) => {
    ...
    try {
      ...
      if (bytesWritten + offset < buffer.length) {
        ...
        return (0, exports2.unixWrite)({ binding: binding2, buffer, offset: bytesWritten + offset, fsWriteAsync });
      }
      ...
      if (err.code === "EAGAIN" || err.code === "EWOULDBLOCK" || err.code === "EINTR") {
        ...
        return (0, exports2.unixWrite)({ binding: binding2, buffer, offset, fsWriteAsync });
      }
      const disconnectError = err.code === "EBADF" || // Bad file number means we got closed
      err.code === "ENXIO" || // No such device or address probably usb disconnect
      err.code === "UNKNOWN" || err.errno === -1;
...
var __importDefault$1 = _commonjsDynamicModules.commonjsGlobal && _commonjsDynamicModules.commonjsGlobal.__importDefault || function(mod) {
  return mod && mod.__esModule ? mod : { "default": mod };
};
...
function requireDist() {
  ...
  (function(exports2) {
    ...
    const debug2 = (0, debug_12.default)("serialport/bindings-cpp");
    __exportStar(dist, exports2);
    __exportStar(darwin, exports2);
    __exportStar(linux, exports2);
    __exportStar(requireWin32(), exports2);
...
(function(exports2) {
  ...
  Object.defineProperty(exports2, "__esModule", { value: true });
  __exportStar(dist$d, exports2);
  __exportStar(dist$c, exports2);
  __exportStar(dist$b, exports2);
  __exportStar(dist$a, exports2);
  __exportStar(dist$9, exports2);
  __exportStar(dist$8, exports2);
  __exportStar(dist$7, exports2);
  __exportStar(dist$6, exports2);
  __exportStar(dist$5, exports2);
  __exportStar(dist$4, exports2);
  __exportStar(serialportMock, exports2);
  __exportStar(serialport, exports2);
})(dist$e);
class Serial extends Adapter {
  constructor(port, options) {
    super();
    this.device = new dist$e.SerialPort({ path: port, ...options, autoOpen: false });
  ...
  static async list() {
    const ports2 = await dist$e.SerialPort.list();
    return ports2;
  }
  open(callback) {
    if (this.device === null)
  ...
  close(callback, timeout = 0) {
    ...
    device.drain(() => {
      device.flush((err) => {
        setTimeout(() => {
          err ? callback && callback(err, device) : device.close((err2) => {
            this.device = null;
            if (callback)
              callback(err2 ?? null, device);
          });
        }, Math.max(timeout, 0));
      });
    });
